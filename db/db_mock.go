...
func (m *MockDBHelper) ReadItems() ([]model.BaseItem, error) {
	m.ctrl.T.Helper()
...
func (mr *MockDBHelperMockRecorder) ReadItems() *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "ReadItems", reflect.TypeOf((*MockDBHelper)(nil).ReadItems))
}
